...
main(int argc, char *argv[])
{
	...
	const GOptionEntry options[] = {
	    ...
	    {"verbose",
	     ...
	     G_OPTION_ARG_NONE,
	     &verbose,
	     N_("Print verbose debug statements"),
	     NULL},
	    {"device",
	     'd',
	     0,
	     G_OPTION_ARG_STRING,
	     &self->device_vid_pid,
	     N_("Specify Vendor/Product ID(s) of DFU device"),
	     N_("VID:PID")},
	    {"transfer-size",
	     't',
	     0,
	     G_OPTION_ARG_STRING,
	     &self->transfer_size,
	     N_("Specify the number of bytes per USB transfer"),
	     N_("BYTES")},
	    {"force",
	     '\0',
	     0,
	     G_OPTION_ARG_NONE,
	     &self->force,
	     N_("Force the action ignoring all warnings"),
	     NULL},
	    {NULL}};
