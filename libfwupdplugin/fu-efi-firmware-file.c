...
static gboolean
fu_efi_firmware_file_parse_stream(FuFirmware *firmware,
				  GInputStream *stream,
				  gsize offset,
...
fu_efi_firmware_file_class_init(FuEfiFirmwareFileClass *klass)
{
	...
	klass_firmware->parse_stream = fu_efi_firmware_file_parse_stream;
